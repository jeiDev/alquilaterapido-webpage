...
import useStyles from "~/components/styles/chat/content.style"
...
const Chat = () => {
    ...
    return (
        <AuthorizationMiddleware>
            <Layout title="Chat">
                <div className={classNames("row", classes.clearfix)}>
                    <div className="col-lg-12">
                        <div className={classNames(classes.card, classes.chatApp)}>
                            <div id="plist" className={classes.peopleList}>
